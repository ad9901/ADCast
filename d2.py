...
"""
	This software is part of ADCast
	Copyright (C) 2021 AD
...
# 1: (For projectors) Put the display in sleep mode when not in use by ADCast 
...
if 'intel_sink_manufacturer_name' in data:
	msg = msg + 'intel_sink_manufacturer_name: ADCast\r\n'
if 'intel_sink_model_name' in data:
	msg = msg + 'intel_sink_model_name: ADCast\r\n'
if 'intel_sink_version' in data:
	msg = msg + 'intel_sink_version: 20.4.26\r\n'
if 'intel_sink_device_URL' in data:
	msg = msg + 'intel_sink_device_URL: https://github.com/ad9901/ADCast\r\n'
